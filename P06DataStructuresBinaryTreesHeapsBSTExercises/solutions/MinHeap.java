package P06DataStructuresBinaryTreesHeapsBSTExercises.solutions;

import P06DataStructuresBinaryTreesHeapsBSTExercises.interfaces.Decrease;
import P06DataStructuresBinaryTreesHeapsBSTExercises.interfaces.Heap;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

public class MinHeap<E extends Comparable<E> & Decrease<E>>  {
    private List<E> data;
